...
public class EndToEndPutGetDel {
	...
	public void testPutGet() throws InterruptedException, KVException, UnknownHostException {
		...
		try {
			assertEquals("TEST 1 get failed", client.get("key1"), "value1");
			assertEquals("TEST 2 get failed", client.get("key2"), "value2");
			assertEquals("TEST 3 get failed", client.get("key3"), "value3");
		...
		try {
			...
			assertEquals("TEST 2new get failed", client.get("key2"), "");
			assertEquals("TEST 3new get failed", client.get("key3"), "");
			assertEquals("TEST 4new get failed", client.get("key4"), "");
		} catch (Exception e) {
			System.out.println("INFO EndToEnd.testPutGet: Finished.");
			e.printStackTrace();
		}
